    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('gender', models.IntegerField(choices=[(0, 'Male'), (1, 'Female')], help_text='What is the patient\'s biological sex? <a href="" target="_next">Why do we need to know?</a>', verbose_name='Biological Sex')),
        ...
        migrations.CreateModel(
            ...
            options={
                'constraints': [models.CheckConstraint(condition=models.Q(('gender__in', [0, 1])), name='gender_valid')],
            },
